...
RUN wget -O /bootstrap/bin/mount https://dl.lochnair.net/dummy.mips
RUN chroot /bootstrap /usr/bin/qemu-mips-static -execve /bin/bash -c '/debootstrap/debootstrap --second-stage'
